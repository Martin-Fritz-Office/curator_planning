...
$landingPage = [
  ...
  'footer' => 'Die artbackstage Toolsammlung ist in laufender BETA-Entwicklung als Teil des Lehrauftrags "Kunst im Kontext (Recht, Geld und Fairness) an der Kunstuniversität Linz. Verwendet werden unter anderem Materialien der IG Bildende Kunst, der KUPF Oberösterreich und aus dem Fair Pay Prozess der IG Kultur. Es werden keine personalisierten Daten gespeichert.',
  'tools' => [
    ['href' => 'index_law.php', 'title' => 'artbackstage | Law (UrhG-Quiz)', 'description' => 'Alternative Landingpage mit 20 Fragen zu zentralen Begriffen und Paragraphen des Urheberrechtsgesetzes.', 'highlight' => true, 'icon' => '<path d="M8 4.5h6l4 4V19a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 6 19V6a1.5 1.5 0 0 1 1.5-1.5z"></path><path d="M14 4.5V9h4"></path><path d="M9 13h6"></path><path d="M9 16h4"></path>'],
