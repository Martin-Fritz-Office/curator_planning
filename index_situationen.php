...
$landingPage = [
  ...
  'primary_cta' => ['href' => 'index.php', 'label' => 'Zur Standard-Toolübersicht'],
  'secondary_cta' => ['href' => 'index.php', 'label' => 'Alle Tools (Home)'],
  'story_intro_title' => 'Ein gemeinsamer Einstieg statt drei separater Seiten',
  'story_intro' => 'Diese Landing-Page vereint den szenariobasierten Einstieg, den Startklar-Pfad und die Rechner-Nutzungsanleitung. Wähle zuerst deine Situation, folge danach dem empfohlenen Ablauf und springe anschließend direkt in die passenden Tools.',
  ...
  'guide_title' => 'Empfohlener Ablauf (vereint aus den drei bisherigen Einstiegsseiten)',
  ...
  'tools' => [
    ['href' => 'index_situationen.php', 'title' => 'Geführter Einstieg (diese Seite)', 'description' => 'Vereint Szenarien, Startklar-Pfad und Nutzungsanleitung in einer Struktur.', 'highlight' => true, 'icon' => '<path d="M12 4.5v15"></path><path d="m6.5 10.5 5.5-6 5.5 6"></path>'],
